...
class SendAuthnRequest
{
    ...
    public static function execute()
    {
        ...
        $samlRequest = (new AuthnRequest($pluginSettings->getAcsUrl(), $pluginSettings->getSpEntityId(), $pluginSettings->getSamlLoginUrl(), $pluginSettings->getForceAuthentication(), $pluginSettings->getLoginBindingType(), $pluginSettings->getAssertionSigned(), $pluginSettings->getResponseSigned()))->build();
